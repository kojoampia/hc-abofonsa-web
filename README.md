...
To build the final jar and optimize the abofonsaWeb application for production, run:
...
Then navigate to [http://localhost:5066](http://localhost:5066) in your browser.
