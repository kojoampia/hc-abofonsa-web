...
import net.jojoaddison.abofonsa.domain.Testimonial.Consent;
...
public class V006SeedTestimonials implements Changelog {
    ...
    private Testimonial adwoaBoateng() {
        return testimonial(
                lt(
    ...
    private Testimonial emmanuelOfori() {
        return testimonial(
                lt(
    ...
    private Testimonial graceAsante() {
        return testimonial(
                lt(
    ...
    private Testimonial drNaaAdjeleyQuartey() {
        return testimonial(
                lt(
