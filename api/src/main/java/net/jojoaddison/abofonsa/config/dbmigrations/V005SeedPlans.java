...
import net.jojoaddison.abofonsa.domain.Plan.Comparison;
import net.jojoaddison.abofonsa.domain.Plan.PlanFeature;
import net.jojoaddison.abofonsa.domain.Plan.Price;
...
public class V005SeedPlans implements Changelog {
    ...
    private Plan plan(
            String code,
            net.jojoaddison.abofonsa.domain.LocalizedText name,
            net.jojoaddison.abofonsa.domain.LocalizedText forWho,
            Price price,
            net.jojoaddison.abofonsa.domain.LocalizedText priceNote,
            boolean featured,
