...
import net.jojoaddison.abofonsa.domain.Section.Item;
...
public class V003SeedSections implements Changelog {
    ...
    private static net.jojoaddison.abofonsa.domain.LocalizedText LocalizedTextEmpty() {
        return net.jojoaddison.abofonsa.domain.LocalizedText.empty();
    }

    private Section section(
            SectionKey key,
            net.jojoaddison.abofonsa.domain.LocalizedText eyebrow,
            net.jojoaddison.abofonsa.domain.LocalizedText heading,
            net.jojoaddison.abofonsa.domain.LocalizedText subheading,
            net.jojoaddison.abofonsa.domain.LocalizedText body,
            List<Item> items) {
        return new Section(
                null,
                1,
