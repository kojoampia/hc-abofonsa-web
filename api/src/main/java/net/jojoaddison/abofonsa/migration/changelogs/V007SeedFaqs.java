...
import net.jojoaddison.abofonsa.content.FaqDocument;
import net.jojoaddison.abofonsa.content.FaqDocument.FaqCategory;
...
public class V007SeedFaqs implements Changelog {
    ...
    private FaqDocument faq(int displayOrder, FaqCategory category, LocalizedText question, LocalizedText answer) {
