...
import net.jojoaddison.abofonsa.content.ServiceDocument;
...
public class V004SeedServices implements Changelog {
    ...
    private ServiceDocument elderlyCompanionCare() {
        return service(
    ...
    private ServiceDocument skilledNursingVisits() {
        return service(
    ...
    private ServiceDocument hospitalToHomeRecovery() {
        return service(
    ...
    private ServiceDocument mentalHealthWellbeing() {
        return service(
    ...
    private ServiceDocument mobilityPhysicalSupport() {
        return service(
    ...
    private ServiceDocument dailyLivingAuxiliaryServices() {
        return service(
