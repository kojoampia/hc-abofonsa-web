...
import net.jojoaddison.abofonsa.content.SiteSettingsDocument;
import net.jojoaddison.abofonsa.content.SiteSettingsDocument.Address;
import net.jojoaddison.abofonsa.content.SiteSettingsDocument.Seo;
...
public class V002SeedSiteSettings implements Changelog {
    ...
    public void execute(MongoTemplate mongoTemplate) {
        var settings = new SiteSettingsDocument(
                null,
                1,
                SiteSettingsDocument.SINGLETON_VALUE,
                "Abofonsa BridgeCare",
                lt(
