...
class ContentControllerTest extends AbstractIntegrationTest {
    ...
    void siteEndpointReturnsFullPayloadForEveryLocale(String locale) {
        var result = restClient
                ...
                .expectBody(SiteContentView.class)
                .returnResult()
                .getResponseBody();
    ...
    void planPricesAreFormattedNotRawNumbers(String locale) {
        var plans = restClient
                ...
                .expectStatus()
                .isOk()
                .expectBody(net.jojoaddison.abofonsa.content.view.PlanView[].class)
                .returnResult()
                .getResponseBody();
        ...
        assertThat(plans).allSatisfy(p -> {
            ...
            // or "...00.00" (spec §10.5's PlanView example: "3.000", not "3.000,00").
            assertThat(p.priceAmount()).doesNotMatch(".*[.,]\\d{2}$");
        });
        assertThat(plans)
                .filteredOn(net.jojoaddison.abofonsa.content.view.PlanView::featured)
                .hasSize(1);
    }
    ...
    void servicesEndpointReturnsAllSixInDisplayOrder() {
        var services = restClient
                ...
                .expectStatus()
                .isOk()
                .expectBody(net.jojoaddison.abofonsa.content.view.ServiceView[].class)
                .returnResult()
                .getResponseBody();
    ...
    void faqsEndpointReturnsAllSeven() {
        restClient
                ...
                .expectStatus()
                .isOk()
                .expectBody(net.jojoaddison.abofonsa.content.view.FaqView[].class)
